...
class plateformUserController extends Controller
{
    /**
    ...
    {
        $data['usercompanies'] = User::where('user_type','=',3)->with('checkout')->get();
        // $data['usercompanies'] = User::with('checkout')->get();
        return view('susers.companies' , $data);
    ...
    public function create(Request $request, $id = null)
    {
        ...
        return view('susers.CompaniesAdd');
    }
    ...
    public function show($id)
    {
        ...
        return view('susers.companyview' ,$data);
    }
