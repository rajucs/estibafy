...
@section('breadcrumb-items')
    ...
    <li class="breadcrumb-item active">{{ trans('lang.companies') }}</li>
@endsection
@section('content')
                ...
                <div class="card o-hidden">
                    <div class="bg-primary b-r-4 card-body">
                        <div class="media static-top-widget">
                            ...
                            <div class="media-body"><span class="m-0">{{ trans('lang.subtotal') }}</span>
                        ...
                        <div class="row">
                          <div class="col-xxl-4 col-lg-12">
                            ...
                            @endif
                              ...
                              <h6>{{ $user->name }}</h6>
                              <div class="media"><img class="img-50 me-1 rounded-circle" src="{{ asset('/assets/images/user/3.jpg') }}" alt="" data-original-title="" title="">
                                <div class="media-body">
                                  <p> @if($user->user_type='2') {{ trans('lang.company') }} @endif</p>
                                </div>
                              </div>
                              <div class="row details">
                                <div class="col-6"><span>{{ trans('lang.email') }} </span></div>
                                <div class="col-6 text-primary">{{ $user->email }} </div>
                                <div class="col-6"> <span>{{ trans('lang.mobile_number') }}</span></div>
                                <div class="col-6 text-primary">{{ $user->mobile }}</div>
                                <div class="col-6"> <span>{{ trans('lang.joining_date') }}</span></div>
                                <div class="col-6 text-primary"> {{ date('M-d-y'),strtotime($user->created_at)}}</div>
                              </div>
