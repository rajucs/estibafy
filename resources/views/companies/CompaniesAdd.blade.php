            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        action="{{ Route('companies.create') }}/{{ $Registration['id'] }}" @endif>
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control" id="" cols="30" rows="5" required><?php if (!empty($DeathCertificate['description'])) {
