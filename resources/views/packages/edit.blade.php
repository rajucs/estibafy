            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>{{ trans('lang.update_package') }}</h5>
                    ...
                    <div class="card-body">
                        ...
                        <form class="user-form" novalidate="novalidate" method="post"
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="name" type="text"
                                            value="{{ $package->name }}" data-bs-original-title="" title="">
                                    ...
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <select name="status" id="status" class="form-control" required="">
                                                <option value="0"
                                                    {{ $package->status == '0' ? 'Selected="Selected"' : '' }}>{{ trans('lang.inactive') }}
                                                </option>
                                                <option value="1"
                                                    {{ $package->status == '1' ? 'Selected="Selected"' : '' }}>{{ trans('lang.active') }}
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <button class="btn btn-primary" type="submit" data-bs-original-title="" title="">{{ trans('lang.update') }}</button>
                        </form>
                    </div>
                </div>
            </div>
