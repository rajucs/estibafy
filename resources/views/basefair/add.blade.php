        ...
        <div class="row">
            <div class="col-sm-12">
                @if (Session::has('success'))
                    <div class="alert alert-success dark alert-dismissible fade show" role="alert"><strong>
                        {{ trans('lang.success') }}! </strong> {{ Session::get('success') }}.
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a style="max-width: 150px;float: right;display: inline-block;margin-top: -42px;"
                            href="{{ Route('basefair') }}" class="btn btn-success">{{ trans('lang.list') }}</a>
                    ...
                    <div class="card-body">
                        ...
                        <form class="user-form" novalidate="novalidate" method="post"
                            action="{{ route('basefairinsert') }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        <label for="name">{{ trans('lang.base_fair_price') }}</label>
                                        <input class="form-control" name="base_fire" type="number" value=""
