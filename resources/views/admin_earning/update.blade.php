                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a style="max-width: 150px;float: right;display: inline-block;margin-top: -42px;"
                            href="{{ Route('adminearning') }}" class="btn btn-success">list</a>
                    ...
                    <div class="card-body">
                        ...
                        <form class="user-form" novalidate="novalidate" method="post"
                            action="{{ route('adminearningedit', $adminearning->id) }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        <label for="name">{{ trans('lang.earning') }} %</label>
                                        <input class="form-control" name="earning_percentage" type="number"
                                            value="{{ $adminearning->earning_percentage }}" data-bs-original-title=""
                                            title="">
