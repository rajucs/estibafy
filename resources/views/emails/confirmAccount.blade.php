            ...
            <table style="width: 650px; margin: 0 auto; background-color: #fff; border-radius: 8px">
                ...
                <tr>
                    <td style="padding: 30px">
                        <h6 style="font-weight: 600">Confirm Account</h6>
                        <p><strong>{{$name}}</strong> your account create successfully.</p>
                        <p style="text-align: center"><a href="{{Route('confirmAccount')}}/{{$code}}" style="padding: 10px; background-color: #7366ff; color: #fff; display: inline-block; border-radius: 4px">Confirm Account</a></p>
                        <p>Click confirm to active you account for access it thanks.</p>
                        <p>Good luck! Hope it works.</p>
                        {{--<p style="margin-bottom: 0">Regards,<br>Webiots Software</p>--}}
                    </td>
                </tr>
                </tbody>
            </table>
