            ...
            <table style="width: 650px; margin: 0 auto; background-color: #fff; border-radius: 8px">
                ...
                <tr>
                    <td style="padding: 30px">
                        <h6 style="font-weight: 600">Account Verified</h6>
                        <p>Your account Verified successfully.</p>
                        <p style="text-align: center"><a href="{{Route('sign_in')}}" style="padding: 10px; background-color: #7366ff; color: #fff; display: inline-block; border-radius: 4px">Log In</a></p>
                        <p>Click Loo in to your account for access it thanks.</p>
