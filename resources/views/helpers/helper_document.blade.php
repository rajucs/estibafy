...
@section('breadcrumb-title')
    <h3>{{ trans('lang.helper_document') }}</h3>
@endsection
@section('breadcrumb-items')
    {{-- <li class="breadcrumb-item">Data Tables</li> --}}
    <li class="breadcrumb-item active">{{ trans('lang.helper_document') }}</li>
@endsection
@section('content')
                                            ...
                                            <div class="project-box"><span class="badge badge-primary">
                                                    @if ($helper->status == '1')
                                                        <a class="btn btn-primary"
                                                            href="{{ route('helperdocumentstatus', $helper->id) }}"
                                                ...
                                                <div class="row details">
                                                    @foreach ($document as $doc)
                                                        <div class="col-6"><span>{{ trans('lang.id_number') }} </span></div>
                                                        <div class="col-6 text-primary">{{ $doc->id_no }} </div>
                                                        <div class="col-6"> <span>{{ trans('lang.expire_date') }}</span></div>
                                                        <div class="col-6 text-primary">
                                                            {{ date('d-m-y'), strtotime($doc->expire_date) }}</div>
                                                        ...
                                                        <div class="blog-box blog-grid text-center">
                                                            <img class="img-fluid top-radius-blog"
                                                                src="{{ asset('/assets/images/govermentImages/medium') }}/{{ $doc->image }}"
                                                                alt="">
