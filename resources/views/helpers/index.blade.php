        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                @if (Session::has('error'))
                    <div class="alert alert-secondary dark alert-dismissible fade show" role="alert"><strong>{{ trans('lang.errir') }}! </strong> {{ Session::get('error_message') }}.
                ...
                <div class="card">
                    <div class="card-header">
                        <h5>{{ trans('lang.helpers') }}</h5>
                        <a style="max-width: 150px;float: right;display: inline-block;margin-top: -42px;"
                            href="{{ Route('helperadd') }}" class="btn btn-success">Add</a>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody id="tbdy">
                                    ...
                                    @foreach ($helpers as $helper)
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('public/assets/' . $helper->image) }}" alt="">
                                            </td>
                                            <td>
                                                <h6> <a
                                                        href="{{ route('helperdocument', $helper->id) }}">{{ $helper->name }}</a>
                                                </h6>
                                            </td>
                                            <td>{{ $helper->email }}</td>
                                            ...
                                            <td>
                                                <!-- <div class="col-md-6"> -->
                                                <a href="{{ route('helperupdate', $helper->id) }}" title=""
                                                    data-bs-original-title="Edit" aria-label="Edit"><i
                                                        class="icofont icofont-edit"></i></a>
                                                <a href="{{ route('helperlist', $helper->id) }} "
                                                    class="btn btn-success btn-xs" type="button"
                                                    data-original-title="btn btn-danger btn-xs" title="">job List</a>
                                                <label class="switch btn ">
                                                    <input data-id="{{ $helper->id }}" type="checkbox" class="btn-status"
                                                        data-offstyle="danger" data-toggle="toggle" data-on="Active"
                                                        data-off="InActive"
                                                        @if ($helper->status == '1') checked @endif />
