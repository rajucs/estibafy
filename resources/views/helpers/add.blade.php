            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="user-form" novalidate="novalidate" method="post" action="{{ route('helperinsert') }}">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        <label for="name">{{ trans('lang.password') }}</label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select name="approved" id="approved" class="form-control" required="">
                                            <option value="Yes">{{ trans('lang.yes') }}
                                            </option>
                                            <option value="No">{{ trans('lang.no') }}
                                            </option>
                                        </select>
                                    </div>
                                </div>
