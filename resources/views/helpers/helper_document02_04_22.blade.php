...
@section('breadcrumb-title')
    <h3>Helper Document</h3>
@endsection
@section('breadcrumb-items')
    {{-- <li class="breadcrumb-item">Data Tables</li> --}}
    <li class="breadcrumb-item active">Helper Document</li>
@endsection
@section('content')
                    ...
                    <div class="bg-primary b-r-4 card-body">
                        <div class="media static-top-widget">
                            ...
                            <div class="media-body"><span class="m-0">Sub Total</span>
                                <h4 class="mb-0 counter">23</h4><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <div class="row">
                          <div class="col-xxl-4 col-lg-12">
                            ...
                            @foreach($document as $doc)
                              <div class="media"><img class="img-50 me-1 rounded-circle" src="{{ asset('/assets/images/govermentImages/thumbnail') }}/{{$doc['image']}}" alt="" data-original-title="" title="">
                              @endforeach
                              </div>
                              <div class="row details">
                              @foreach($document as $doc)
                                <div class="col-6"><span>Id Number </span></div>
                                <div class="col-6 text-primary">{{ $doc['id_no'] }} </div>
                                <div class="col-6"> <span>Expire Date</span></div>
                                <div class="col-6 text-primary">{{ date('d-m-y'),strtotime($doc['expire_date']) }}</div>
                                <div class="col-6"> <span>Joining Date</span></div>
                                <div class="col-6 text-primary"> {{ date('M-d-y'),strtotime($doc['created_at'])}}</div>
                                @endforeach
                              </div>
