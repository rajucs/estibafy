                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a style="max-width: 150px;float: right;display: inline-block;margin-top: -42px;"
                                href="{{ Route('payment_method.index') }}" class="btn btn-success">{{ trans('lang.list') }}</a>
                            @endif

                        </div>
                        <div class="card-body">

                         <form class="user-form" novalidate="novalidate" method="post" action="{{ route('payment_method.store') }}">
                             @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="secret_key" type="text" value=""
                                                data-bs-original-title="" title="">
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-group">
                                                ...
                                                <select name="status" id="status" class="form-control" required="">
                                                    ...
                                                    <option value="2">{{ trans('lang.inactive') }}
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
