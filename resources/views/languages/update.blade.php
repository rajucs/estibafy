                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="field_name" type="text" value="{{ $language->field_name }}"
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="translation" type="text" value="{{ $language->translation }}"
                                            data-bs-original-title="" title="">
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="lang" id="">
                                            <option value="en" {{ $language->lang=='en' ? 'selected':'' }}>English</option>
                                            <option value="es" {{ $language->lang=='es' ? 'selected':'' }}>Spanish</option>
                                            <option value="fr" {{ $language->lang=='fr' ? 'selected':'' }}>France</option>
                                        </select>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
