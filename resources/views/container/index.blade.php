...
@section('breadcrumb-items')
    <li class="breadcrumb-item active">{{ trans('lang.container') }}</li>
@endsection
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                @if (Session::has('success'))
                    <div class="alert alert-success dark alert-dismissible fade show" role="alert"><strong>Su{{ trans('lang.success') }}! </strong> {{ Session::get('success') }}.
                        <button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"
                            data-bs-original-title="" title=""></button>
                    </div>
                @endif
                ...
                <div class="card">
                    <div class="card-header">
                        <h5>{{ trans('lang.all_containers') }}</h5>
                        <a style="max-width: 150px;float: right;display: inline-block;margin-top: -42px;"
                            href="{{ Route('containersadd') }}" class="btn btn-success">Add</a>
                    </div>
                    <div class="card-body">
                                    ...
                                    @foreach ($containers as $con)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <label class="badge badge-info">In Active</label>
                                                @endif
                                            </td>

                                            <td>
                                                <a href="{{ route('containersupdate', $con->id) }}" title=""
                                                    data-bs-original-title="Edit" aria-label="Edit"><i
                                                        class="icofont icofont-edit"></i></a>

                                                <a title="Delete" href="{{ route('containersdelete', $con->id) }}"
                                                    class="confirmDelete" recordid="">
                                                ...
                                                <label class="switch btn ">
                                                    <input data-id="{{ $con->id }}" type="checkbox" class="btn-status"
                                                        data-offstyle="danger" data-toggle="toggle" data-on="Active"
                                                        data-off="InActive"
                                                        @if ($con->status == '1') checked @endif />
        ...
        $('.btn-status').change(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    html += '<strong>Success';
                    html += '    ! </strong> Container Status has been updated';
                    html +=
                        '<button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"';
